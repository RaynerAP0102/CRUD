...
namespace Sistema.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Nombre,Edad,Genero")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Nombre,Edad,Genero")] Estudiante estudiante)
        {
            if (id != estudiante.id)
            {
                return NotFound();
